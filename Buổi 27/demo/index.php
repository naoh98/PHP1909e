...
include_once "mvc/model/Database.php";
include_once "mvc/controller/PostController.php";
include_once "mvc/controller/ProductController.php";
include_once "mvc/controller/IndexController.php";
include_once "mvc/controller/ErrorController.php";
